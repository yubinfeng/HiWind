...
(function (window, $, undefined) {
    ...
    //ybf 2016/3/21
    // 删除当前字符串右边的指定字符。
    coreString.deletLastChar = function (str, lastChar) {      
        return String.endsWith(str, ",") ? String.left(str, str.length - 1) : str;
    };
    coreString.prototype.deletLastChar = function (str, lastChar) { return coreString.deletLastChar(this, str, lastChar); };
    ...
    coreJquery.prototype.serializeObject = function (options) {
        ...
        Author:ybf
        Data:2015/04/29
        对display='nane'不过滤（combobox multiple=true的控件）        
        */
        ...
        /*
         Author:ybf
         Data:2015/06/23
         validatebox display=false  Cancel the filtration 
         */
        ...
        list = this.map(function () {
            ...
            {
                b = $(this).hasClass("easyui-combobox") ? true : false;
                b = b ? ($(this).combobox("options")["multiple"] == true ? true : false) : false;
            }
            return (this.name|| b) &&
				rsubmittable.test(this.nodeName) && !rsubmitterTypes.test(this.type) ;
        }).map(function (i, elem) {
        ...
        function getElemsVal(elems) {
            ...
            */
            ...
            if ($("#"+elems[0].name).hasClass("easyui-combobox"))
            {               
                if ($("#" + elems[0].name).combobox("options")["multiple"] == true) { values = values.filter(function (t) { return t != "" }) }
            }           
            if ($("#" + elems[0].name).hasClass("easyui-euploadify"))
            {               
                values = values.filter(function (t) { return t != "" });
            }            
            /*ybf*/
